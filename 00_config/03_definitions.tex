...
\newcommand{\SlideCover}{{
            \usebackgroundtemplate{\includegraphics[width=\paperwidth]{./03_images/template/title_a.png}}
            \color{fgcolor}
...
\newcommand{\SlideTextA}[2]{{
            \usebackgroundtemplate{\includegraphics[width=\paperwidth]{./03_images/template/content_a.png}}
            \color{fgcolor}
            \begin{frame}
                \frametitle{#1}
                #2
...
\newcommand{\SlideEnd}{{
            \usebackgroundtemplate{\includegraphics[width=\paperwidth]{./03_images/template/ending_b.png}}
            \color{bgcolor}
            \setbeamertemplate{footline}{}
            \begin{frame}
                \centering
